...
class MethodUpdateRequest extends \Google\Protobuf\Internal\Message
{
     ...
     */
    protected $payment_method_updates = null;
    ...
    public function hasPaymentMethodUpdates()
    {
        return isset($this->payment_method_updates);
    }

    public function clearPaymentMethodUpdates()
    {
        unset($this->payment_method_updates);
    }
